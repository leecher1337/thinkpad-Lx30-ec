...
cfg_offs_mem_fwver=$((0x358b6))   # Offset of Firmware version string in RAM (absolute address)
cfg_stri_fwver="H1EC34WW(1.14)"   # EC Firmware version number this patch is for
