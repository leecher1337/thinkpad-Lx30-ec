...
patches() {
	...
	$1 $"\x62\x7b\x01\x00\x94\x10\xb0\x20\xfe\xff\xe2\x10" $"\x62\x73\x01\x00\x52\x73\x01\x00\x00\x2c\x00\x2c" $((0x28c12+$2)) $3 || return
	$1 $"\x80\x18\x42\x03" $"\xe0\x18\x7e\x00" $((0x28b7c+$2)) $3 || return
	$1 $"\x30" "\xc0" $((0x289f2+$2)) $3 || return
	$1 $"\x00\x18\x38\x05" $"\xe0\x18\x54\x00" $((0x28986+$2)) $3 || return
}
